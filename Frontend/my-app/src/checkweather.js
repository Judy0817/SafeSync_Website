...
var OPENWEATHER_API_KEY = '2601fcbe1411562dc72d4050e299d2c7'; // Replace with your OpenWeather API key
var STREET_NAME = 'Street A'; // Replace with a street name you want to test
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1.default.get("https://api.openweathermap.org/data/2.5/weather?q=".concat(STREET_NAME, "&appid=").concat(OPENWEATHER_API_KEY, "&units=imperial"))];
                case 1:
                    response = _a.sent();
                    data = response.data;
                    console.log("Weather data for ".concat(STREET_NAME, ":"));
